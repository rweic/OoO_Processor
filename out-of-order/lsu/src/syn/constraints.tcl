...
# uncertainty
set_clock_uncertainty -setup ${clk_setup_uncertainty} "clk_i"
set_clock_uncertainty -hold ${clk_hold_uncertainty}  "clk_i"
# transition
...
# outputs 
set_output_delay $blanket_output_delay -clock "clk_i" [all_outputs]
set_load [load_of $blanket_input_load] [all_outputs]

# inputs 
set_input_delay $blanket_input_delay -clock "clk_i" \
