...
report_timing -path full -delay max -max_paths 50  -cap -nets -nosplit > "./$reports/timing.max.fullpath.rpt"
report_timing -path full -delay min -max_paths 50  -cap -nets -nosplit > "./$reports/timing.min.fullpath.rpt"
